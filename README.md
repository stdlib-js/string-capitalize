...
```javascript
capitalize = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/string-capitalize@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/string-capitalize/tags). For example,

```javascript
capitalize = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/string-capitalize@v0.2.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/string-capitalize/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/string-capitalize/actions/workflows/test.yml?query=branch:v0.2.1
...
[deno-readme]: https://github.com/stdlib-js/string-capitalize/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/string-capitalize/tree/umd
[umd-readme]: https://github.com/stdlib-js/string-capitalize/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/string-capitalize/tree/esm
[esm-readme]: https://github.com/stdlib-js/string-capitalize/blob/esm/README.md
